...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # enable remote client to connect LLMEngine using zmq
    "ENABLE_ENGINE_ZMQ_REMOTE_ACCESS": lambda: int(os.getenv("ENABLE_ENGINE_ZMQ_REMOTE_ACCESS", "0")),
    # LLMEngine recieve requests port
    "ZMQ_RECV_REQUEST_SERVER_PORT": lambda: os.getenv("ZMQ_RECV_REQUEST_SERVER_PORT", "8200"),
    # LLMEngine send response port
    "ZMQ_SEND_RESPONSE_SERVER_PORT": lambda: os.getenv("ZMQ_SEND_RESPONSE_SERVER_PORT", "8201"),
    # LLMEngine recieve control command port
